...
def p_declaracion_asignar(t):
    '''
        expresion : INT IDENTIFICADOR ASIGNAR expresion PUNTOCOMA
                    | STRING IDENTIFICADOR ASIGNAR CADENA PUNTOCOMA
    '''
    #nombres[t[1]] = t[3]
    nombres[t[2]] = t[4]
...
def p_expresion_if(t):
    '''
    expresion : SI PARIZQ ENTERO MAYORQUE ENTERO PARDER LLAIZQ LLADER SINO LLAIZQ LLADER
                | SI PARIZQ ENTERO MENORQUE ENTERO PARDER LLAIZQ LLADER SINO LLAIZQ LLADER
                | SI PARIZQ ENTERO IGUAL ENTERO PARDER LLAIZQ LLADER SINO LLAIZQ LLADER
    '''
    # if(3<5)
